        ...
        async with chat_lock(project_id):
            ...
            system = {
                ...
                "content": (
                    ...
                    "For mathematics, use polished step-by-step tutoring format. Use Markdown headings such as "
                    "### Given and ### Step 1, horizontal separators when helpful, and LaTeX rendered by MathJax: "
                    "use \\( ... \\) for inline math and \\[ ... \\] or $$ ... $$ for displayed equations. "
                    "Write fractions with \\frac, group multi-line work in displayed equations, and use \\boxed "
